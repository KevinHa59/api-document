...
export const darkTheme = createTheme({
  ...
  theme: {
    colors: {
      background: "$000",
      backgroundLinear: "linear-gradient(to right top, #15021c, #1a0624, #1e092c, #220b34, #270b3d)",
      default: "#fff",
    ...
    box: {
      color: "#fff",
      background: "linear-gradient(to right top, #8017a6, #8713bb, #8d0fd1, #920ce7, #940dff)",
      boxShadow: "2px 2px 5px #8017a6",
      ...baseTheme.theme.box,
    },
    stack: {
